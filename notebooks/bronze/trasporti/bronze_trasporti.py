...
# Data: 2026-06-08
# Descrizione: Ingestion giornaliera T_TRASP_MTV da ADLS Gen2 landing zone (CSV/Parquet).
#              MODE = DELTA_MERGE: MERGE su chiave naturale SP_ID+MAG_SITO_COD+DATABOLLA+NUMBOLLA.
#              NOTA: area trasporti non core (flag) — da rivalutare in fase di scoping.
...
NOTEBOOK_NAME  = "bronze_trasporti"
SOURCE_SYSTEM  = "cnd"
TABLE_NAME     = "t_trasp_mtv"
MODE           = "DELTA_MERGE"

MERGE_KEYS     = ["SP_ID", "MAG_SITO_COD", "DATABOLLA", "NUMBOLLA"]

# Schema sorgente esplicito (colonne reali verificate — NON modificare/inventare)
SOURCE_COLS = [
    "SP_ID", "AUTISTA_SPED_COD", "AUTOMEZZO", "VETTORE", "DATABOLLA",
    "NUMBOLLA", "STATO", "DATACONSPREV", "AZIONE_COD", "DATA_AZIONE",
    "MTV_COD", "QTA", "SP_NUMSIGILLORIT", "MAG_SITO_COD", "SOCIO_COD",
    "MAG_SITO_TRANSITO_COD", "NUM_GITA"
]
