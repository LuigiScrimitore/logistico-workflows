...
# Area: Preparazione Spedizioni / Anagrafica PDV
# Layer: Bronze
# Versione: 1.0.0
# Data: 2026-06-09
# Descrizione: Ingestion 1:1 della sorgente RAW APVPUNTO_VENDITA verso Bronze Delta.
#              Ridisegno SCELTA B: si legge la VERA sorgente raw (cdt-estr-raw-landing/apvpunto_vendita),
#              NON piu' lo staging wl1_apvpunto_vendita. Bronze 1:1 puro (nessuna derivata, nessun join).
#              MODE = FULL_OVERWRITE (anagrafica). Schema-on-read (StringType).
#              Riferimento: config landing simulator (systems.cdt_estr_raw.apvpunto_vendita); §11 catalogo RAW.
...
NOTEBOOK_NAME  = "bronze_apvpunto_vendita"
SOURCE_SYSTEM  = "cdt_estr_raw"
TABLE_NAME     = "apvpunto_vendita"
MODE           = "FULL_OVERWRITE"
...
# COMMAND ----------
# MAGIC %md #### 3. Costruzione path landing (cdt-estr-raw-landing/apvpunto_vendita)
