...
# Versione: 3.0.0
# Data: 2026-06-08
# Descrizione: Ingestion file landing zone -> Delta Bronze per STRUTTURA_MAG (struttura magazzino, logistix multi-sito).
...
NOTEBOOK_NAME  = "bronze_struttura_mag"
SOURCE_SYSTEM  = "logistix"
TABLE_NAME     = "struttura_mag"
MODE           = "FULL_OVERWRITE"
IS_MULTISITE   = True

SOURCE_COLS = [
    "MAG_SITO_COD", "STRM_COD_MAGAZZINO", "STRM_CORSIA", "STRM_COLONNA", "STRM_PIANO",
    "STRM_COD_CLAS_POSPA", "STRM_COD_TIPO_POSPA", "STRM_NRO_MAX_PAL_AL",
    "STRM_NRO_MAX_PAL_LA", "STRM_NRO_MAX_PAL_PR", "STRM_COD_ZONA_MAG",
    "STRM_COD_SETTOR_MAG", "STRM_STATO_POSPA", "STRM_FLAG_SERVIZIO",
    "STRM_FLAG_IMPILABIL", "STRM_NRO_PALL_GIAC", "STRM_COD_MSI_PREN",
    "ART_RADICE_COD", "ART_VAR_LOGIS_COD", "STRM_DATA_MODIFICA",
    "STRM_NOME_UTENTE", "STRM_CAMPATA", "STRM_CONTR_PESO", "STRM_CIEUNPESO",
    "STRM_ALTEZZA_CM", "STRM_LIVELLO", "STRM_TIPO_STRUTTURA", "STRM_CODICE_CONTROLLO",
]
