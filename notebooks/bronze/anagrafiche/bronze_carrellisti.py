...
# Versione: 3.0.0
# Data: 2026-06-08
# Descrizione: Ingestion file landing zone -> Delta Bronze per CARRELLISTI (anagrafica carrellisti, logistix multi-sito).
...
NOTEBOOK_NAME  = "bronze_carrellisti"
SOURCE_SYSTEM  = "logistix"
TABLE_NAME     = "carrellisti"
MODE           = "FULL_OVERWRITE"
IS_MULTISITE   = True

SOURCE_COLS = [
    "MAG_SITO_COD", "CRLLS_COD_CARRELLIST", "CRLLS_DES_CARRELLIST",
    "CRLLS_FLAG_CARR_ATT", "CRLLS_NOME_TERMINALE", "CRLLS_FLAG_RICOVERO",
    "CRLLS_FLAG_PALLINT", "CRLLS_AZIENDA_PREP_STA",
]
