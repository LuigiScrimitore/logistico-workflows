...
# Versione: 3.0.0
# Data: 2026-06-08
# Descrizione: Ingestion file landing zone -> Delta Bronze per RICEVITORI (anagrafica ricevitori, logistix multi-sito).
...
NOTEBOOK_NAME  = "bronze_ricevitori"
SOURCE_SYSTEM  = "logistix"
TABLE_NAME     = "ricevitori"
MODE           = "FULL_OVERWRITE"
IS_MULTISITE   = True

SOURCE_COLS = [
    "MAG_SITO_COD", "RICV_COD_RICEVITOR", "RICV_COGNOME",
    "RICV_NOME", "RICV_PWD", "RICV_FLAG_RICV_ATT", "RICV_NOME_TERMINALE",
]
