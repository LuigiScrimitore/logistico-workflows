...
# Versione: 3.0.0
# Data: 2026-06-08
# Descrizione: Ingestion file landing zone -> Delta Bronze per TABGEN (tabella generalizzata, logistix multi-sito).
...
SOURCE_COLS = [
    "MAG_SITO_COD", "TGEN_NRO_TAB", "TGEN_COD_SEDE", "TGEN_CHIAVE1_TAB",
    "TGEN_CHIAVE2_TAB", "TGEN_DES_TABGEN", "TGEN_CAMPO1_TAB",
    "TGEN_CAMPO2_TAB", "TGEN_DATA_MODIFICA", "TGEN_NOME_UTENTE",
]
