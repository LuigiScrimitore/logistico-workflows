...
# Versione: 3.0.0
# Data: 2026-06-08
# Descrizione: Ingestion file landing zone -> Delta Bronze per CORSIE (anagrafica corsie magazzino, logistix multi-sito).
...
SOURCE_COLS = [
    "MAG_SITO_COD", "CORSI_COD_MAGAZZINO", "CORSI_CORSIA", "CORSI_DES_CORSIA",
    "CORSI_COD_ZONA_MAG", "CORSI_COD_SETTOR_MAG", "CORSI_COD_CLAS_POSPA",
    "CORSI_FLAG_IMPILABIL", "CORSI_FLAG_RICERCA_P", "CORSI_ZP_LATO_TRIANG",
    "CORSI_FLAG_PREPARAZI", "CORSI_PERC_ART_X_ZP", "CORSI_NRO_MAX_COLONN",
    "CORSI_NRO_COLONNE_CO", "CORSI_NRO_PIANI", "CORSI_COD_TIPO_POSPA",
    "CORSI_SCANSIONE", "CORSI_PTY_PRELIEVO", "CORSI_X1", "CORSI_Y1",
    "CORSI_NRO_MAX_PAL_AL", "CORSI_NRO_MAX_PAL_PR", "CORSI_NRO_MAX_PAL_LA",
    "CORSI_DATA_MODIFICA", "CORSI_NOME_UTENTE", "CORSI_TIPO_CHECK_DIGIT",
    "CORSI_QUADRONE", "CORSI_TIPO_CORSIA",
]
