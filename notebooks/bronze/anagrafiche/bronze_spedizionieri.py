...
# Versione: 3.0.0
# Data: 2026-06-08
# Descrizione: Ingestion file landing zone -> Delta Bronze per SPEDIZIONIERI (anagrafica spedizionieri, logistix multi-sito).
...
NOTEBOOK_NAME  = "bronze_spedizionieri"
SOURCE_SYSTEM  = "logistix"
TABLE_NAME     = "spedizionieri"
MODE           = "FULL_OVERWRITE"
IS_MULTISITE   = True

SOURCE_COLS = [
    "MAG_SITO_COD", "SPE_CODICE", "SPE_COGNOME", "SPE_NOME", "SPE_PWD",
]
