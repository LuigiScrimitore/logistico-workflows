...
# Versione: 3.0.0
# Data: 2026-06-08
# Descrizione: Ingestion file landing zone -> Delta Bronze per PREPARATORI (anagrafica preparatori, logistix multi-sito).
...
NOTEBOOK_NAME  = "bronze_preparatori"
SOURCE_SYSTEM  = "logistix"
TABLE_NAME     = "preparatori"
MODE           = "FULL_OVERWRITE"
IS_MULTISITE   = True

SOURCE_COLS = [
    "MAG_SITO_COD", "PREP_COD_PREPARATOR", "PREP_DES_PREPARATOR",
    "PREP_FLAG_PREP_ATT", "PREP_NOME_TERMINALE", "PREP_PID",
    "PREP_NRO_RIEPILOGO", "PREP_NRO_GABBIA", "PREP_AZIENDA_PREP",
    "PREP_AZIENDA_PREP_STA", "PREP_TIPO_SOCIO", "PREP_PASSWORD",
    "PREP_VISUAL_DATI", "PREP_COD_AREA_MERCEOLOGICA", "PREP_AGG_GIACENZA",
    "PREP_COLLI_HR", "PREP_MESSAGGIO", "PREP_MATRICOLA",
]
