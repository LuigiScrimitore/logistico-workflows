...
# Versione: 3.0.0
# Data: 2026-06-08
# Descrizione: Bronze STO_TES_CARICHI (testate carichi) — MODE=DELTA_MERGE.
...
NOTEBOOK_NAME = "bronze_carichi_testate"
SOURCE_SYSTEM = "logistix"
TABLE_NAME    = "sto_tes_carichi"
MODE          = "DELTA_MERGE"
IS_MULTISITE  = SOURCE_SYSTEM == "logistix"

MERGE_KEYS    = ["MAG_SITO_COD", "STCAR_NRO_CARICO", "STCAR_COD_MAGAZZINO"]
...
source_schema = StructType([
    ...
    StructField("STCAR_COD_MAGAZZINO",       StringType(), True),
    StructField("STCAR_COD_SEDE",            StringType(), True),
    StructField("STCAR_NRO_ORDINE",          StringType(), True),
    StructField("STCAR_NRO_CARICO",          StringType(), True),
    StructField("STCAR_DATA_CARICO",         StringType(), True),
    StructField("STCAR_COD_FORNITORE",       StringType(), True),
    StructField("STCAR_DIV_FORNITORE",       StringType(), True),
    StructField("STCAR_DATA_EMISS_ORD",      StringType(), True),
    StructField("STCAR_DATA_CONFE_ORD",      StringType(), True),
    StructField("STCAR_TIPO_ORDINE",         StringType(), True),
    StructField("STCAR_COD_RIORDINATO",      StringType(), True),
    StructField("STCAR_NRO_RIF_ORD_CI",      StringType(), True),
    StructField("STCAR_COD_GESTIONE",        StringType(), True),
    StructField("STCAR_NRO_OFFERTA",         StringType(), True),
    StructField("STCAR_TIPO_CONSEGNA",       StringType(), True),
    StructField("STCAR_COD_CORRIERE",        StringType(), True),
    StructField("STCAR_TIPO_PAGAMENTO",      StringType(), True),
    StructField("STCAR_DILAZIONE",           StringType(), True),
    StructField("STCAR_TIPO_TRASPORTO",      StringType(), True),
    StructField("STCAR_DATA_ULT_SOLLE",      StringType(), True),
    StructField("STCAR_NRO_SOLLECITI",       StringType(), True),
    StructField("STCAR_TIPO_TRASM_ORD",      StringType(), True),
    StructField("STCAR_DATA_TRASM_ORD",      StringType(), True),
    StructField("STCAR_NOTE_COMMERCIA",      StringType(), True),
    StructField("STCAR_NOTE",                StringType(), True),
    StructField("STCAR_NRO_STRALCIO",        StringType(), True),
    StructField("STCAR_DATA_MODIFICA",       StringType(), True),
    StructField("STCAR_FLAG_TRASFERITO",     StringType(), True),
    StructField("STCAR_COD_OPERATORE",       StringType(), True),
    StructField("STCAR_TRASFERITO_SWAP",     StringType(), True),
    StructField("STCAR_DATA_ESTRAZIONE_DWH", StringType(), True),
])
