...
# Versione: 3.0.0
# Data: 2026-06-08
# Descrizione: Bronze TRACCIACE178 (traccia etichette CE178) — MODE=DELTA_MERGE.
...
NOTEBOOK_NAME = "bronze_traccia_ce178"
SOURCE_SYSTEM = "logistix"
TABLE_NAME    = "tracciace178"
MODE          = "DELTA_MERGE"
IS_MULTISITE  = SOURCE_SYSTEM == "logistix"

MERGE_KEYS    = ["MAG_SITO_COD", "CE178_NRO_ETICHETTA", "CE178_NRO_CARICO"]
...
source_schema = StructType([
    ...
    StructField("CE178_NRO_ETICHETTA",       StringType(), True),
    StructField("CE178_SSCC",                StringType(), True),
    StructField("CE178_COD_MSI",             StringType(), True),
    StructField("CE178_NRO_CARICO",          StringType(), True),
    StructField("CE178_DATA_CARICO",         StringType(), True),
    StructField("CE178_NRO_ORDINE",          StringType(), True),
    StructField("CE178_NOME_UTENTE",         StringType(), True),
    StructField("CE178_DATA_INSERIMENTO",    StringType(), True),
    StructField("CE178_DATA_MODIFICA",       StringType(), True),
    StructField("CE178_ANNULLATO",           StringType(), True),
    StructField("CE178_TRASFERITO_STAT",     StringType(), True),
    StructField("CE178_DATA_ESTRAZIONE_DWH", StringType(), True),
])
