...
# Versione: 3.0.0
# Data: 2026-06-08
# Descrizione: Ingestion landing zone -> Delta Bronze per CARTELLINO (presenze operatori).
...
NOTEBOOK_NAME = "bronze_cartellino"
SOURCE_SYSTEM = "logistix"
TABLE_NAME    = "cartellino"
MODE          = "DELTA_MERGE"
IS_MULTISITE  = SOURCE_SYSTEM == "logistix"

# Schema sorgente esplicito (colonne reali verificate - NON modificare/inventare)
SOURCE_COLS = [
    "MAG_SITO_COD", "CARTE_COD_CARRELLIST", "CARTE_DATA",
    "CARTE_LOGIN", "CARTE_LOGOUT", "CARTE_ATTUALE",
]

# MERGE_KEYS - chiave naturale (solo DELTA_MERGE). Tutte presenti nello schema reale.
MERGE_KEYS = [
    "MAG_SITO_COD", "CARTE_COD_CARRELLIST", "CARTE_DATA",
]
