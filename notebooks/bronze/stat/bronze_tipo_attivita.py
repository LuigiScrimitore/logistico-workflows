...
# Data: 2026-06-08
# Descrizione: Ingestion giornaliera TIPO_ATTIVITA_ECO da ADLS Gen2 landing zone (CSV/Parquet).
#              MODE = FULL_OVERWRITE: tabella di lookup, overwrite completo (stato corrente).
...
NOTEBOOK_NAME  = "bronze_tipo_attivita"
SOURCE_SYSTEM  = "stat"
TABLE_NAME     = "tipo_attivita_eco"
MODE           = "FULL_OVERWRITE"
...
SOURCE_COLS = [
    "TIPO_ATTIVITA_ID", "TIPO_ATTIVITA_COD", "TIPO_ATTIVITA_DES"
]
...
# COMMAND ----------
# MAGIC %md #### 6. Scrittura FULL_OVERWRITE (lookup, stato corrente)
