...
# DEPRECATO (OP-02): dimensione master fornita dal flusso Retail Master Data (LU_GIORNO/LU_MESE).
# Non eseguire in produzione: il Gold legge le lookup condivise in sola lettura dallo schema
